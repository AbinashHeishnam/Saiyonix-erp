...
import {
  ...
  submit,
  update,
} from "@/modules/assignments/controller";
import {
...
assignmentsRouter.get(
  "/",
  authMiddleware,
  allowRoles("TEACHER", "STUDENT", "PARENT"),
  requirePermission("assignment:read"),
  validate({ query: listAssignmentQuerySchema }),
  list
);
...
assignmentsRouter.post(
  ...
  requirePermission("assignment:update"),
  validate({ params: assignmentIdParamSchema }),
  ...uploadSingle({ module: "assignments", fieldName: "file" }),
  addAttachment
);
...
assignmentsRouter.post(
  ...
  validate({ params: assignmentIdParamSchema, body: submitAssignmentSchema }),
  submit
);
...
assignmentsRouter.get(
  ...
  allowRoles("TEACHER"),
  requirePermission("assignment:read"),
  validate({ params: assignmentIdParamSchema, query: listAssignmentSubmissionsQuerySchema }),
  listSubmissions
);
