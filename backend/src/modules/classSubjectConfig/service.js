...
async function ensureSubjectsBelongToSchool(schoolId, subjectIds) {
...
export async function upsertClassSubjectConfig(schoolId, payload) {
...
export async function getClassSubjectConfig(schoolId, classId) {
...
export async function copyClassSubjectConfigFromPreviousYear(schoolId, payload) {
    ...
    const previousSubjectsByClass = new Map();
    ...
    const targetSubjectsByClass = new Map();
    for (const item of targetConfigs) {
        const set = targetSubjectsByClass.get(item.classId) ?? new Set();
    ...
    for (const targetClass of targetClasses) {
        ...
        const existing = targetSubjectsByClass.get(targetClass.id) ?? new Set();
