...
import {
  getClassSubjectConfig,
  upsertClassSubjectConfig,
  copyClassSubjectConfigFromPreviousYear,
} from "@/modules/classSubjectConfig/service";
...
export async function getByClass(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    const schoolId = getSchoolId(req);
