...
import {
  ...
  chatRoomMessages,
  pinChatMessage,
} from "@/modules/classroom/controller";
import {
  classSubjectIdParamSchema,
  chatRoomIdParamSchema,
  chatRoomMessagesQuerySchema,
  chatMessageIdParamSchema,
  classroomAnnouncementCreateSchema,
  classroomAssignmentCreateSchema,
  classroomAssignmentSubmitSchema,
  classroomNotesCreateSchema,
...
classroomRouter.get(
  "/section/:sectionId",
  authMiddleware,
  allowRoles("TEACHER", "STUDENT", "PARENT", "ADMIN", "SUPER_ADMIN"),
  allowClassroomRead,
...
classroomRouter.get(
  ...
  allowRoles("TEACHER", "STUDENT", "PARENT", "ADMIN", "SUPER_ADMIN"),
  allowClassroomRead,
  validate({ params: classSubjectIdParamSchema, query: studentIdQuerySchema }),
  subjectDetail
);
...
classroomRouter.get(
  ...
  authMiddleware,
  allowRoles("TEACHER", "STUDENT", "PARENT", "ADMIN", "SUPER_ADMIN"),
  validate({ params: chatRoomIdParamSchema, query: chatRoomMessagesQuerySchema }),
  chatRoomMessages
);
...
classroomRouter.post(
  ...
  validate(classroomAssignmentCreateSchema),
  createClassroomAssignment
);
...
classroomRouter.post(
  ...
  validate(classroomNotesCreateSchema),
  createClassroomNote
);
...
classroomRouter.post(
  ...
  allowRoles("TEACHER", "ADMIN", "SUPER_ADMIN"),
  requirePermission("note:create"),
  validate(classroomAnnouncementCreateSchema),
  createClassroomAnnouncement
);
...
classroomRouter.post(
  ...
  validate(classroomAssignmentSubmitSchema),
  submitClassroomAssignment
);
