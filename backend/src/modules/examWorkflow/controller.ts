...
import {
  ...
  getMarksEntryContext,
  getMarksEntryMatrix,
  submitMarks,
  submitMarksBulk,
  getExamResultStatus,
  publishExamResult,
  getExamResultForActor,
  createResultRecheckComplaint,
  listComplaints,
  getTeacherExamAnalytics,
  getTeacherMyClassAnalytics,
} from "@/modules/examWorkflow/service";
...
export async function teacherAssignedExams(
  req: AuthRequest,
  res: Response,
  next: NextFunction
) {
...
export async function teacherMarksEntryContext(
  req: AuthRequest,
  res: Response,
  next: NextFunction
) {
  try {
    const schoolId = getSchoolId(req);
    const actor = getActor(req);
    const data = await getMarksEntryContext(schoolId, req.query as any, actor);
...
export async function teacherMarksEntryMatrix(
  req: AuthRequest,
  res: Response,
  next: NextFunction
) {
  try {
    const schoolId = getSchoolId(req);
    const actor = getActor(req);
    const data = await getMarksEntryMatrix(schoolId, req.query as any, actor);
...
export async function teacherSubmitMarks(
  req: AuthRequest,
  res: Response,
  next: NextFunction
) {
...
export async function teacherSubmitMarksBulk(
  req: AuthRequest,
  res: Response,
  next: NextFunction
) {
...
export async function adminExamResultStatus(
  req: AuthRequest,
  res: Response,
  next: NextFunction
) {
...
export async function getExamResultMe(
  req: AuthRequest,
  res: Response,
  next: NextFunction
) {
...
export async function studentResultRecheck(
  req: AuthRequest,
  res: Response,
  next: NextFunction
) {
...
export async function teacherExamAnalytics(
  req: AuthRequest,
  res: Response,
  next: NextFunction
) {
  try {
    const schoolId = getSchoolId(req);
    const actor = getActor(req);
    const data = await getTeacherExamAnalytics(schoolId, req.query as any, actor);
...
export async function teacherMyClassAnalytics(
  req: AuthRequest,
  res: Response,
  next: NextFunction
) {
  try {
    const schoolId = getSchoolId(req);
    const actor = getActor(req);
    const data = await getTeacherMyClassAnalytics(schoolId, req.query as any, actor);
