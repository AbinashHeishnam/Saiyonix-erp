...
async function ensureStudentAccess(schoolId, studentId, actor) {
...
export async function getStudentHistory(schoolId, studentId, actor) {
    ...
    const [classSubjects, teacherAssignments, attendanceGrouped, feeRecords, promotionRecords] = await Promise.all([
    ...
    const teacherBySectionYear = new Map();
