...
import { getSchoolOverview, getPublicSchoolOverview, updateSchoolOverview, } from "@/modules/school/overview.service";
...
export async function getPublicOverview(_req, res, next) {
    try {
...
export async function getPublicLogo(_req, res, next) {
    try {
        const data = await getPublicSchoolOverview();
...
export async function updateOverview(req, res, next) {
    try {
        const schoolId = getSchoolId(req);
