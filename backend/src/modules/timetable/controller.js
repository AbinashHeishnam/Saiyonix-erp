...
import { bulkCreateTimetable, createSubstitution, deleteTimetableSlot, getSectionTimetable, getTimetableLockStatus, getTimetableWorkload, getTimetableMeta, getTimetableOptions, getParentTimetableForUser, getStudentTimetableForUser, getTeacherTimetable, getTeacherTodaySchedule, setTimetableLock, validateTimetableSlot, } from "@/modules/timetable/service";
...
export async function validateSlot(req, res, next) {
    try {
        const schoolId = getSchoolId(req);
...
export async function sectionTimetable(req, res, next) {
    try {
        const schoolId = getSchoolId(req);
...
export async function teacherTimetable(req, res, next) {
    try {
        const schoolId = getSchoolId(req);
...
export async function teacherToday(req, res, next) {
    try {
        const schoolId = getSchoolId(req);
...
export async function studentTimetable(req, res, next) {
    try {
        const schoolId = getSchoolId(req);
        const userId = req.user?.sub;
        if (!userId) {
...
export async function parentTimetable(req, res, next) {
    try {
        const schoolId = getSchoolId(req);
        const userId = req.user?.sub;
        if (!userId) {
...
export async function substitute(req, res, next) {
    try {
        const schoolId = getSchoolId(req);
...
export async function lockTimetable(req, res, next) {
    try {
        const schoolId = getSchoolId(req);
...
export async function unlockTimetable(req, res, next) {
    try {
        const schoolId = getSchoolId(req);
...
export async function timetableLockStatus(req, res, next) {
    try {
        const schoolId = getSchoolId(req);
...
export async function timetableWorkload(req, res, next) {
    try {
        const schoolId = getSchoolId(req);
...
export async function timetableMeta(req, res, next) {
    try {
        const schoolId = getSchoolId(req);
        const sectionId = getParamString(req.params.sectionId);
        if (!sectionId) {
...
export async function timetableOptions(req, res, next) {
    try {
        const schoolId = getSchoolId(req);
