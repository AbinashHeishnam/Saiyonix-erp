...
function mapTeacherToIdCard(school, teacher) {
...
export async function listTeacherIdCardsForAdmin(schoolId) {
...
export async function getTeacherIdCardForUser(schoolId, userId) {
    const school = await prisma.school.findUnique({
        where: { id: schoolId },
        select: { name: true, logoUrl: true, address: true, phone: true },
    });
...
export async function updateTeacherIdCardDetailsAdmin(schoolId, teacherId, payload) {
    const teacher = await prisma.teacher.findFirst({
...
export async function updateTeacherIdCardPhotoAdmin(schoolId, teacherId, photoUrl) {
    const teacher = await prisma.teacher.findFirst({
        where: { id: teacherId, schoolId, deletedAt: null },
...
export async function createTeacher(schoolId, payload) {
    try {
...
export async function getTeachers(schoolId, academicYearId, pagination) {
    const where = {
        schoolId,
        deletedAt: null,
    };
...
export async function updateTeacher(schoolId, id, payload) {
...
export async function updateTeacherStatus(schoolId, id, payload) {
    const teacher = await prisma.teacher.findFirst({
        where: { id, schoolId, deletedAt: null },
        select: { id: true, userId: true },
    });
...
export async function getTeacherTimetable(schoolId, id) {
    return listTimetableForTeacher(schoolId, id);
}
export async function getTeacherProfileByUserId(schoolId, userId) {
    const teacher = await prisma.teacher.findFirst({
        where: { schoolId, userId, deletedAt: null },
...
export async function getTeacherProfileById(schoolId, teacherId) {
    const teacher = await prisma.teacher.findFirst({
        where: { id: teacherId, schoolId, deletedAt: null },
        select: teacherProfileSelect,
    });
...
export async function updateTeacherProfileById(schoolId, teacherId, payload) {
    const teacher = await prisma.teacher.findFirst({
        where: { id: teacherId, schoolId, deletedAt: null },
        select: { id: true },
    });
...
export async function getTeacherPublicProfile(id) {
    const teacher = await prisma.teacher.findFirst({
