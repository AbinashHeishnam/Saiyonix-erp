...
export async function createSection(schoolId, payload) {
...
export async function listSections(schoolId, filters, pagination) {
    const resolvedAcademicYearId = filters?.academicYearId ?? (await getActiveAcademicYearId(schoolId));
    const where = {
        deletedAt: null,
...
export async function getSectionById(schoolId, id) {
...
export async function updateSection(schoolId, id, payload) {
...
async function notifySectionClassTeacherAssigned(schoolId, sectionId, teacherId) {
    try {
