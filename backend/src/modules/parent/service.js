...
export function calculateParentProfileCompletion(parent, studentProfile) {
    const fields = [
        parent.fullName,
        parent.mobile,
        parent.email,
...
function buildParentUpdateData(payload) {
    const data = {};
...
function buildStudentProfileData(payload) {
    const data = {};
    ...
    if (payload.medicalInfo !== undefined)
        data.medicalInfo = payload.medicalInfo;
    return data;
}
...
async function getParentById(schoolId, parentId) {
    const parent = await prisma.parent.findFirst({
...
async function fetchLinkedStudents(parentId) {
...
export async function getParentProfileByUserId(schoolId, userId) {
...
export async function getParentProfileById(schoolId, parentId) {
...
async function updateParentProfileInternal(schoolId, parentId, payload) {
...
export async function updateParentProfileByUserId(schoolId, userId, payload) {
    const parent = await getParentByUserId(schoolId, userId);
    return updateParentProfileInternal(schoolId, parent.id, payload);
}
export async function updateParentProfileById(schoolId, parentId, payload) {
    await getParentById(schoolId, parentId);
    return updateParentProfileInternal(schoolId, parentId, payload);
}
export async function updateStudentPhotoByParentUserId(schoolId, userId, studentId, photoUrl) {
    const parent = await getParentByUserId(schoolId, userId);
    ...
    const info = profile?.medicalInfo;
...
export async function listParents(schoolId, pagination) {
