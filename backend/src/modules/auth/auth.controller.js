import { listUserSessions, loginUser, logoutAllSessions, logoutUser, resetPasswordWithToken, sendTeacherSetupOtp, sendPasswordResetOtpForMobile, verifyPasswordResetOtpForMobile, verifyTeacherSetupOtp, completeTeacherSetup, completeAdminFirstLogin, verifyAdminFirstLoginOtp, requestTeacherActivationOtp, verifyTeacherActivationOtp, completeTeacherActivation, requestTeacherForgotPasswordOtp, verifyTeacherForgotPasswordOtp, completeTeacherForgotPassword, refreshAccessToken, registerUser, unlockUserAccount, sendAdminSetupOtp, } from "@/modules/auth/auth.service";
...
import { passwordResetSchema, passwordResetSendSchema, passwordResetVerifySchema, teacherIdentifierSchema, teacherOtpVerifySchema, teacherPasswordCompleteSchema, } from "@/modules/auth/auth.validation";
...
export async function adminUnlockUser(req, res, next) {
    try {
...
export async function adminSetupSendOtp(req, res, next) {
    try {
        if (!req.user?.sub) {
...
export async function sendSetupOtp(req, res, next) {
    try {
        if (!req.user?.sub) {
            return next(new ApiError(401, "Unauthorized"));
        }
...
export async function verifySetupOtp(req, res, next) {
    try {
        if (!req.user?.sub) {
            return next(new ApiError(401, "Unauthorized"));
        }
...
export async function completeAdminSetup(req, res, next) {
    try {
        if (!req.user?.sub) {
            return next(new ApiError(401, "Unauthorized"));
        }
...
export async function verifyAdminSetupOtp(req, res, next) {
    try {
        if (!req.user?.sub) {
            return next(new ApiError(401, "Unauthorized"));
        }
...
export async function requestTeacherActivation(req, res, next) {
    try {
...
export async function verifyTeacherActivation(req, res, next) {
    try {
...
export async function completeTeacherActivationController(req, res, next) {
    try {
...
export async function requestTeacherForgotPassword(req, res, next) {
    try {
        const parsed = teacherIdentifierSchema.safeParse(req.body);
        if (!parsed.success) {
            throw new ApiError(400, "Invalid identifier");
...
export async function verifyTeacherForgotPassword(req, res, next) {
    try {
        const parsed = teacherOtpVerifySchema.safeParse(req.body);
        if (!parsed.success) {
            throw new ApiError(400, "Invalid OTP");
...
export async function completeTeacherForgotPasswordController(req, res, next) {
    try {
        const parsed = teacherPasswordCompleteSchema.safeParse(req.body);
        if (!parsed.success) {
            throw new ApiError(400, "Invalid payload");
