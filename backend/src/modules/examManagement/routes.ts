...
} from "@/modules/examManagement/controller";
import {
  addExamScheduleSchema,
  addRoomAllocationSchema,
  createExamAdminSchema,
...
router.post(
  ...
  validate(createExamAdminSchema),
  adminCreateExam
);
...
router.post(
  ...
  validate(addExamScheduleSchema),
  adminAddSchedule
);

router.post(
  "/admin/exam/schedule/delete",
  authMiddleware,
  allowRoles("SUPER_ADMIN", "ADMIN", "ACADEMIC_SUB_ADMIN"),
  requirePermission("exam:update"),
...
router.post(
  "/admin/exam/room-allocation",
  authMiddleware,
  allowRoles("SUPER_ADMIN", "ADMIN", "ACADEMIC_SUB_ADMIN"),
  requirePermission("exam:update"),
  validate(addRoomAllocationSchema),
  adminAddRoomAllocation
);
...
router.patch(
  ...
  allowRoles("SUPER_ADMIN", "ADMIN", "ACADEMIC_SUB_ADMIN"),
  requirePermission("exam:update"),
  validate({ params: examIdParamSchema, body: setFinalExamSchema }),
  adminSetFinalExam
);
