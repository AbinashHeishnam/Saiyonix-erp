...
import { buildSchoolHeaderLines, type SchoolBranding } from "@/utils/schoolBranding";
...
function sanitizeLogoUrl(raw?: string | null) {
  if (!raw) return null;
...
async function fetchLogoBuffer(rawUrl?: string | null) {
...
export async function documentHeaderBuilder(
