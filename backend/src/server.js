...
const LOG_HTTP_TRAFFIC = process.env.LOG_HTTP_TRAFFIC === "true" || process.env.NODE_ENV !== "production";
let stopWorker = null;
let server = null;
...
async function validateStartup() {
    ...
    try {
        ...
        logger.warn("[system] Prisma schema mismatch detected (Exam.timetablePublishedAt missing). Run prisma migrate deploy or prisma db push.");
    }
}
