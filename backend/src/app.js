...
export async function registerBullBoard(appInstance) {
    ...
    appInstance.use("/admin/queues", authMiddleware, allowRoles("SUPER_ADMIN", "ADMIN", "ACADEMIC_SUB_ADMIN"), bullBoardServer.getRouter());
}
